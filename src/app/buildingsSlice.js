...
const initialState = {
  ...
  buildingListByUrlStatus: "idle",
  buildingListByUrlError: null,
};
...
const buildingsSlice = createSlice({
  ...
  initialState,
  reducers: {
    clearSupportListByUrlStatus: (state) => {
      state.buildingListByUrlStatus = "idle";
    },
  },
});

export const { clearSupportListByUrlStatus } = buildingsSlice.actions;
